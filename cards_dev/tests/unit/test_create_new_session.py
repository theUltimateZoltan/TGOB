...
def test_generated_id_unique(session_table: Table, dummy_session: GameSession, predictable_word_generator):
...
def test_simple_session_creation(session_table: Table):
