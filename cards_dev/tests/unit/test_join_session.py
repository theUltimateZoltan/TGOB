...
def session_join_request(session_id: str) -> str:
    return json.dumps({"session_id": session_id, "is_coordinator": False, "player_data": {"username": "mock_un", "email": "mocked_email"}})
...
def test_join_to_non_existing_fails(game_data, session_archive, post_to_connection) -> None:
    mocked_connection_id = "123456"
